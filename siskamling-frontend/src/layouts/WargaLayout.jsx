...
const navItems = [
  ...
  { to: '/warga/ronda', label: 'Jadwal Ronda', icon: '🌙' },
  { to: '/warga/kamtibmas', label: 'Laporan Kamtibmas', icon: '🚨' },
  { to: '/warga/rumah-kosong', label: 'Rumah Kosong', icon: '🏡' },
  { to: '/warga/panic', label: 'Panic Button', icon: '🆘' },
]
